...
from agent.tools import present_file, view_image, memory_search, sessions_list, sessions_send, sessions_spawn, sessions_history, manage_crons, manage_config, manage_auth, send_message, queue_for_main
...
tools = [http_request, fetch_url, present_file, view_image, memory_search, manage_config, manage_crons, manage_auth, send_message, queue_for_main, sessions_list, sessions_history, sessions_send, sessions_spawn]
