...
- memory_search: Mandatory recall step: semantically search MEMORY.md + memory/*.md, session transcripts, and meeting transcripts before answering questions about prior work, decisions, dates, people, preferences, or todos; returns top snippets with path + lines. Use source param to filter: "memory" (MEMORY.md + memory/*.md), "session-transcripts", or "meeting-transcripts".
