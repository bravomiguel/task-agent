...
- memory_search (meeting transcripts): Also indexes meeting transcripts from /mnt/meeting-transcripts/. Use source param to filter: "memory", "session-transcripts", or "meeting-transcripts".
