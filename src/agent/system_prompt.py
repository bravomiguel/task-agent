...
- memory_search: Mandatory recall step: semantically search MEMORY.md + memory/*.md and session transcripts before answering questions about prior work, decisions, dates, people, preferences, or todos; returns top snippets with path + lines. Also indexes meeting transcripts (/mnt/meeting-transcripts/) in case helpful.
