...
```bash
python3 /skills/arxiv-search/arxiv_search.py "your search query" [--max-papers N]
```
...
```bash
python3 /skills/arxiv-search/arxiv_search.py "protein folding prediction"
```

Search for bioinformatics methods:
```bash
python3 /skills/arxiv-search/arxiv_search.py "genome assembly algorithms"
```
