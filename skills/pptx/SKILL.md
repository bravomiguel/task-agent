---
name: pptx
description: "Presentation creation, editing, and analysis. Use this when you need to work with presentations (.pptx files) for: (1) Creating new presentations, (2) Modifying or editing content, (3) Working with layouts, (4) Adding comments or speaker notes, or any other presentation tasks"
---
...
**Note**: The unpack.py script is located at `/skills/pptx/ooxml/scripts/unpack.py`. If the script doesn't exist at this path, use `find /skills -name "unpack.py"` to locate it.
...
2. **PREREQUISITE - Extract html2pptx library**:
   - Extract the library next to your script: `mkdir -p html2pptx && tar -xzf /skills/pptx/html2pptx.tgz -C html2pptx`
