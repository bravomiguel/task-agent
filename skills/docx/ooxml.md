...
- **Tracked changes**: Use `<w:del>` and `<w:ins>` tags with `w:author="Lazlo"` outside `<w:r>` elements
...
export PYTHONPATH=/skills/docx:$PYTHONPATH

# Option 2: Inline with script execution
PYTHONPATH=/skills/docx python3 your_script.py
```
...
**Text Insertion:**
```xml
<w:ins w:id="1" w:author="Lazlo" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
**Text Deletion:**
```xml
<w:del w:id="2" w:author="Lazlo" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
<w:ins w:author="Jane Smith" w:id="16">
  <w:del w:author="Lazlo" w:id="40">
    <w:r><w:delText>monthly</w:delText></w:r>
  </w:del>
</w:ins>
<w:ins w:author="Lazlo" w:id="41">
