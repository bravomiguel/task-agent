...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Lazlo", initials: str = "L"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Lazlo")
            initials: Author initials (default: "L")
        """
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Lazlo")
            initials: Default author initials for comments (default: "L")
        """
