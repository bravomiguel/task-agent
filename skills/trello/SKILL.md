...
2. `python3 /mnt/scripts/fetch_auth.py trello` — fetch credentials
...
Run this before any Trello command. If you get a 401 error, re-run `python3 /mnt/scripts/fetch_auth.py trello` to refresh.
